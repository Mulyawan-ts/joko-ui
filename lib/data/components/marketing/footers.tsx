...
export const footers: ComponentType = {
  ...
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    },
    {
      ...
      code: `<footer class="bg-white border-t border-gray-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
      ...
      <div class="lg:col-span-1">
        <div class="flex items-center space-x-3 mb-4">
          ...
          <span class="text-xl font-semibold text-gray-900">JokoUI</span>
        </div>
        <p class="text-gray-600 text-sm leading-relaxed mb-6">
          Membangun solusi digital yang transformatif untuk bisnis masa depan dengan teknologi terkini dan tim ahli.
        </p>
        <div class="flex space-x-4">
          <a href="#" class="text-gray-400 hover:text-gray-700 transition-colors duration-300">
      ...
      <div>
        ...
        <ul class="space-y-4">
          <li>
            <a href="#" class="text-gray-600 hover:text-gray-900 text-sm transition-colors duration-300 block">
              Tentang Kami
            </a>
          </li>
          <li>
        ...
        <form class="space-y-4">
          <div>
            <input 
              ...
              class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-300 outline-none"
            />
          </div>
          <button 
            type="submit" 
            class="w-full bg-gray-900 text-white px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
          >
            Berlangganan
          </button>
        </form>
      ...
      <div class="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        ...
        <div class="text-center md:text-left">
          <p class="text-xs text-gray-500">
            &copy; <span id="current-year"></span> JokoUI. All rights reserved.
          </p>
        </div>

        <!-- Legal Links -->
        <div class="flex flex-wrap justify-center gap-6">
          <a href="#" class="text-xs text-gray-500 hover:text-gray-700 transition-colors duration-300">
            Kebijakan Privasi
          </a>
          <a href="#" class="text-xs text-gray-500 hover:text-gray-700 transition-colors duration-300">
            Syarat Layanan
